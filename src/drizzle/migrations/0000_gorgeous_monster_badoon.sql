CREATE TYPE "public"."jls_experience_level" AS ENUM('junior', 'mid-level', 'senior');--> statement-breakpoint
CREATE TYPE "public"."jls_status" AS ENUM('draft', 'published', 'delisted');--> statement-breakpoint
CREATE TYPE "public"."jls_type" AS ENUM('internship', 'part-time', 'full-time');--> statement-breakpoint
CREATE TYPE "public"."jls_location_requirement" AS ENUM('in-office', 'hybrid', 'remote');--> statement-breakpoint
CREATE TYPE "public"."jls_wage_interval" AS ENUM('hourly', 'monthly', 'yearly');--> statement-breakpoint
CREATE TYPE "public"."jas_stage" AS ENUM('denied', 'applied', 'interested', 'interviewed', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listings" (
	...
	"wage" integer,
	"wageInterval" "jls_wage_interval",
	"stateAbbreviation" varchar,
	"city" varchar,
	"isFeatured" boolean DEFAULT false NOT NULL,
	"locationRequirement" "jls_location_requirement" NOT NULL,
	"experienceLevel" "jls_experience_level" NOT NULL,
	"status" "jls_status" DEFAULT 'draft' NOT NULL,
	"type" "jls_type" NOT NULL,
...
CREATE TABLE "job_applications" (
	...
	"coverLetter" text,
	"rating" integer,
	"stage" "jas_stage" DEFAULT 'applied' NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
